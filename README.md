...
この翻訳は、『Zero Sievert 日本語WIKI』([https://wiki3.jp/zero_sievert](https://wiki3.jp/zero_sievert)) の内容を大いに参考にさせていただきました。

言語設定から「日本語（改）」を選択してご利用ください。

最新版ではRounded M+フォントを採用しています（詳細・配布条件は公式サイトを参照してください：[http://jikasei.me/font/rounded-mplus/about.html](http://jikasei.me/font/rounded-mplus/about.html)）。
